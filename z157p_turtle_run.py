...
# ...악당 거북이의 속도가 계속 빨라지면 너무 빨리 잡히므로, 쫓아오는 악당 거북이의 방향을
#     다섯번에 한번 꼴로 바꿔 난이도를 조절함.
...
# ...t.clear() : 거북이로 그린 그림을 모두 지움.    
    t.clear() 
    t.goto(0, 100)
    t.write(m1, False, "center", ("", 20))
    t.goto(0, -100)
    t.write(m2, False, "center", ("", 15))
# ...t.home() : 거북이가 그린 그림은 그대로 두고, 거북이를 기본 상태로 돌림.
#                        처음 거북이 그래픽을 시작했을 때의 위치인 원점(0, 0)으로 돌아가 오른쪽을 바라봄.
    t.home()
